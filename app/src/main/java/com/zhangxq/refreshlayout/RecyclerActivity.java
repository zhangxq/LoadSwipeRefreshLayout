...
/**
 * Created by zhangxiaoqi on 2019/4/11.
 */

public class RecyclerActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener, OnLoadListener {
    ...
    private class RecyclerAdapter extends LoadRecyclerAdapter {
        ...
        public RecyclerView.ViewHolder onCreateItemViewHolder() {
            return new MyViewholder(LayoutInflater.from(RecyclerActivity.this).inflate(R.layout.view_list_item, null));
        }
